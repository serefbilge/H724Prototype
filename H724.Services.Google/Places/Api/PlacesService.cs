...
using H724.Services.Google.Places.Models.CheckIn;
using H724.Services.Google.Places.Models.Details;
using H724.Services.Google.Places.Models.Report;
using H724.Services.Google.Places.Models.Search;
using Ninject;
using RestSharp;
using RestSharp.Extensions;

namespace H724.Services.Google.Places.Api
{
