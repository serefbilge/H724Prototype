...
namespace H724.Services.Expedia.Hotels.Api.Fake
{
    /// <summary>
    ...
    public class FakeExpediaService : AbstractExpediaService
    {
        ...
        /// H724.Services.Expedia.Hotels.Api.Mock.Content
        /// </summary>
        private readonly string _contentPath = Path.Combine(new Uri(Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase)).LocalPath, "Hotels", "Api", "Fake", "Content");
